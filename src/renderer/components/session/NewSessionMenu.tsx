...
export const SESSION_OPTIONS: SessionOption[] = [
  ...
  { type: 'claude-code-yolo', label: 'Claude YOLO', icon: claudeIcon },
  { type: 'claude-code-wsl', label: 'Claude(WSL)', icon: claudeIcon },
  { type: 'claude-code-yolo-wsl', label: 'Claude YOLO(WSL)', icon: claudeIcon },
