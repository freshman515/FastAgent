...
export const BUILTIN_SLASH_COMMANDS: ClaudeGuiSlashCommandDefinition[] = [
  ...
  { kind: 'command', name: 'stats', aliases: ['cost'], description: 'Open token + cost statistics for the active conversation.', tag: 'local' },
  { kind: 'command', name: 'usage', aliases: [], description: 'Show real Claude subscription usage (session / week / extra).', tag: 'local' },
